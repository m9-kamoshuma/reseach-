...
for i_alpha0=1:size(alpha0_list,2)
    ...
    for i_alpha1=1:size(alpha1_list,2)
        ...
        for i_eta =1:size(eta_list,2)
            ...
            %                 for i3=-1:1
            %                     for i4=-1:1
            %                         const_st = [Phi0+alpha0*P    k*i1*BC.'*P      k*i2*BC.'*P     k*i3*BC.'*P      k*i4*BC.'*P       P;
            %                                            k*i1*P*BC          -eta*P                   z                     z                    z                  z; 
            %                                            k*i2*P*BC               z                  -eta*P                 z                    z                 z; 
            %                                            k*i3*P*BC               z                     z                   -eta*P               z                 z;
            %                                            k*i4*P*BC               z                     z                     z                 -eta*P             z;
            %                                            P                            z                     z                     z                     z              -Eps*eye(n)];
            %         
            %                       const_us = [Phi1-alpha1*P    k*i1*BC.'*P      k*i2*BC.'*P     k*i3*BC.'*P      k*i4*BC.'*P       P;
            %                                            k*i1*P*BC          -eta*P                   z                     z                    z                  z; 
            %                                            k*i2*P*BC               z                  -eta*P                 z                    z                 z; 
            %                                            k*i3*P*BC               z                     z                   -eta*P               z                 z;
            %                                            k*i4*P*BC               z                     z                     z                 -eta*P             z;
            %                                            P                            z                     z                     z                     z              -Eps*eye(n)];
            %                         LMI=[LMI, const_st <= -EpsN6];
            %                         LMI=[LMI, const_us<=-EpsN6];
            
            %N=3を試す場合はendを二つコメントアウト，LMI中のEpsN6をEpsN4に変更        
                                    const_st = [Phi0+alpha0*P    k*i1*BC.'*P      k*i2*BC.'*P            P;
                                                       k*i1*P*BC          -eta*P                   z                     z; 
                                                       k*i2*P*BC               z                  -eta*P                z; 
                                                       P                            z                     z                   -Eps*eye(n)];
                    
                                  const_us = [Phi1-alpha1*P    k*i1*BC.'*P      k*i2*BC.'*P          P;
                                                       k*i1*P*BC          -eta*P                   z                    z; 
                                                       k*i2*P*BC               z                  -eta*P               z;                                         
                                                       P                            z                     z                -Eps*eye(n)];
...
%{
%search minmum rate
[min_rate,min_rate_index]=min(parameter_list(8,:));
